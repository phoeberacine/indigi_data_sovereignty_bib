...
```{r echo = FALSE, out.width="100%", fig.cap = "Building Indigenous data sovereignty through Indigenous data governance (Figure 1, Carroll, Rodriguez-Lonebear, and Martinez 2019)"}
...
```{r echo=FALSE, out.width="100%", fig.cap = "Indigenous and mainstream data principles, and the orientation of these principles towards data, people and purpose (Fig 1, Carroll et al. 2020)."}
