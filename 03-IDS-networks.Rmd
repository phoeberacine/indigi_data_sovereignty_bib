...
#### The Global Indigenous Data Alliance ([GIDA](https://www.gida-global.org/)) {-}
Shares frameworks, tools, and processes to help guide the practice of Indigenous Data Sovereignty around the globe. Notably, GIDA created the [CARE principles](https://www.gida-global.org/care) for Indigenous Data Governance. 

```{r echo=FALSE, fig.cap = "The CARE and FAIR Principles (GIDA 2019)."}
