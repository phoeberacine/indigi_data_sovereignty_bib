...
```{r echo=FALSE, "Census Powwow, Snap Judgement"}
...
```{r echo = FALSE, , fig.cap = "Building Indigenous data sovereignty through Indigenous data governance (Figure 1, Carroll, Rodriguez-Lonebear, and Martinez 2019)"}
...
```{r echo=FALSE, fig.cap = "Indigenous and mainstream data principles, and the orientation of these principles towards data, people and purpose (Fig 1, Carroll et al. 2020)."}
...
knitr::include_graphics("images/bclabels.png")
